...
<head>
  ...
  <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css'><link rel="stylesheet" href="./sjtyle.css">
<style type="text/css">
.red-text {
...
<title>Happy Diwali 2024</title>
    <audio type="audio/mpeg" controls="none" id="audio1" src="https://www.soundjay.com/nature/sounds/matches-1.mp3"></audio>
...
<body>
    <div class="container-fluid">
        <h1 class="red-text text-center">Happy Diwali Guys</h1>
        <br>
      <center><span><h2>click on screen</h2></span>  </center>
    </div> 
